...
<html>
    <head>
        ...
        <title>Sistepad - Listagem de Moedas</title>
    </head>
    <body>
            ...
            <div class="table-responsive">
                <table class="table table-hover" id="tabelaunidademedida">
                    ...
                    <tr>
                        ...
                        <td><a href="/Sistepad/acoes?acao=excluiUnidadeMedida&codunidademedida=<%= unid.get(i).getCodUnidadeMedida()%>" OnClick="return confirm('Deseja realmente excluir esta Moeda?')" class= " fa fa-trash-o col-lg-12"></a></td>
                    </tr>
                    <%
                        }
                    %>    
