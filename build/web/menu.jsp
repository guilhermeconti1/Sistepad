...
<html>
    <head>
        ...
        <title>Sistepad- Sistema de Gerenciamento de Despesas</title>
        <!-- Bootstrap Core CSS -->
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 2">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="menu.jsp">Sistepad - Sistema de Gerenciamento de Despesas</a>
                </div>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="unidademedida.jsp"><i class="glyphicon glyphicon-record"></i> Moeda</a>
                            </li>
                            <li>
                                <a href="categoriaproduto.jsp"><i class="glyphicon glyphicon-filter"></i> Categoria</a>
                            </li>
                            <!-- comment        <li>
