            ...
            <div class="table-responsive">
                <table class="table table-hover" id="tabelacategorias">
                    ...
                    <tr>
                        ...
                        <td><a href="/Sistepad/acoes?acao=excluiCategoriaProduto&codcategoria=<%= cepe.get(i).getCodcategoria()%>" OnClick="return confirm('Deseja realmente excluir a categoria?')" class= " fa fa-trash-o col-lg-12"></a></td>
                    </tr>
                    <%
                        }
                    %>    
