                ...
                <form name="cadastroUnidade" id="cadastroUnidade" method="post" action="/Sistepad/acoes?acao=cadastroUnidadeMedida" onSubmit="return validarCampos(this)">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div>
                                <div class="col-lg-6">
                                    * <label>Nome da Moeda</label>
                                    <input type="text" class="form-control" maxlength="60" id="nomeunidade" name="nomeunidade" placeholder="Descrição da moeda" value="<%= unidadeMedida.getNome()%>">
                                </div>
                            ...
                            <div class="col-lg-4">
                                <!-- Div Botões-->
                                <button type="submit" id="btngravar" name="btngravar" class="btn btn-success">Gravar Moeda</button>
                    ...
                    <form name="pesunidademed" id="pesunidademed" method="post" action="">
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><i class="fa fa-list-alt"></i> Listagem Moedas</h3>
                                </div>

                                <br>
                                <div class="col-md-3">
                                    <input type="text"  class="form-control" id="um" name="um" placeholder="Digite o nome da moeda" value="">
                                </div>
