                ...
                <form name="cadProduto" id="cadProduto" method="post" action="/Sistepad/acoes?acao=cadastroProduto" onSubmit="return validarCampos(this)">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div>
                                <div class="col-lg-6">
                                    * <label for="codcategoriaproduto" > Categoria de Produto</label>
                            ...
                            <div>
                                <div class="col-lg-6">
                                    * <label for="codunidademedida" > Unidade de Medida</label>
                            ...
                            <div>
                                <div class="col-lg-6">
                                    * <label>Data Primeira Venda</label>
                ...
                <div class="modal-content">
                    <form name="pescat" id="pescat" method="post" action="">
                        <div class="col-lg-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><i class="fa fa-list-alt"></i> Lista de Categorias de Produtos </h3>
                                </div>

                                <br>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="cp" name="cp" placeholder="Categoria de Produto" onfocus="this.value = '';" value="">
                                </div>
                ...
                <div class="modal-content">
                    <form name="pesuni" id="pesuni" method="post" action="">
                        <div class="col-lg-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><i class="fa fa-list-alt"></i> Lista Unidade de Medida </h3>
                                </div>

                                <br>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="um" name="um" placeholder="Unidade de Medida" onfocus="this.value = '';" value="">
                                </div>
