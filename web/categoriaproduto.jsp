...
<html>
    ...
    <head>
        ...
        <title>Sistepad - Categoria</title>
    </head>
                    ...
                    <form name="pescat" id="pescat" method="post" action="">
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><i class="fa fa-list-alt"></i> Listagem Categoria</h3>
                                </div>

                                <br>
                                <div class="col-md-3">
                                    <input type="text"  class="form-control" id="cep" name="cep" placeholder="Digite o nome da Categoria" value="">
                                </div>
